...
def problem2_4():
    ...
    random.seed(70)
    for i in range(0,10):
        stat.append(5*random.random()+30)
    print (stat)
...
def problem2_7():
    ...
    side1= input("Enter lenght of side a,:  " )
    a = float(side1)
    
    side2= input("Enter lenght of side b,:  " )
    b = float(side2)
    
    side3= input("Enter lenght of side c,:  " )
    c = float(side3)

    s = .5*(a + b + c)
    area_triangle =  (s-a)*(s-b)*(s-c)
    x=area_triangle
    sqrt= x**(1/3.)
    print(s)
    print (area_triangle)
...
def problem2_8(temp_list):
    ...
    import statistics
    print (temp_list)
    print('the average is also the mean and its =' , statistics.mean(temp_list))
    print('the maximum number is: ', max(temp_list))
    print ('the minimum number is: ', min(temp_list))
