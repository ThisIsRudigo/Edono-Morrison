...
def make_random():
    ...
    random.seed(17)
    for i in range(0,10):
        real_numb.append(random.random())
    return real_numb

def make_random():
    morrison = make_random(
    print (morrison)
...
"""
temperatures = [52, 61, 45, 50, 44, 34, 57, 80, 91, 50, 38, 91, 84, 20, 55, 23, 83, 42, 44, 84]
#Mean:  56.4
#Median:  51.0
